			...
			<div className='container mx-auto px-4'>
				<div className='flex flex-wrap text-left lg:text-left'>
					<div className='w-full lg:w-6/12 px-4'>
						...
						<h5 className='text-lg mt-0 mb-2 text-gray-300'>Find us on any of these platforms, we respond 1-2 business days.</h5>
						...
						<div className='flex flex-wrap items-top mb-6'>
							<div className='w-full lg:w-4/12 px-4 ml-auto'>
								...
								<ul className='list-none'>
									<li>
										<a
											className='text-gray-300 hover:text-white no-underline font-semibold block pb-2 text-sm'
				...
				<hr className='my-6 border-b-gray-600' />
				<div className='flex flex-wrap items-center md:justify-between justify-center'>
					<div className='w-full md:w-4/12 px-4 mx-auto text-center'>
						<div className='text-sm text-gray-300 font-semibold py-1'>
							...
							<a href='https://pravodoc.ru' className='text-gray-300 hover:text-white no-underline' target='_blank'>
								{' '}
								Pravodoc.ru
							</a>
						</div>
